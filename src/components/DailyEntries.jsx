              ...
              <>
                ...
                <div className="flex items-center justify-end gap-3 mb-6 pb-6 border-b border-gray-200">
                  ...
                  <a
                    ...
                    className="flex items-center justify-center gap-2 px-4 py-2 text-sm font-medium text-purple-600 hover:text-purple-700 hover:bg-purple-50 rounded-lg border border-purple-100 transition-colors duration-200"
                  ...
                  <a
                    ...
                    className="flex items-center justify-center gap-2 px-4 py-2 text-sm font-medium text-green-600 hover:text-green-700 hover:bg-green-50 rounded-lg border border-green-100 transition-colors duration-200"
